...
if (isset($_POST["submit"])) {
  if (isset($_POST["name"]) && isset($_POST["username"]) && isset($_POST["birthdate"]) && isset($_POST["city"]) && isset($_POST["email"]) && isset($_POST["password"]) && isset($_POST["gender"])) {
    ...
    $req_check_user = "SELECT username FROM users WHERE usermane LIKE '$username'";
    ...
    if ($age < 18) {
      ...
      $req_create_user = "INSERT INTO users(banner, avatar, email, password, name, username, birthdate, gender, city) VALUES('https://tinyurl.com/ycku5ym8', 'https://tinyurl.com/ycku5ym8','$email', '$password_hashed', '$name', '$username', '$birthdate', '$gender', '$city')";
